...
if (unrealGlobal) {//smm230624
	...
	if (verticesEdit) {//smm230624
		...
		if (instancedMesh) {
			...
			if (loadContent && layoutPolygon) {////smm230624
			...
			}//smm230624//loadContent && layoutPolygon
		}//smm230624//instanceMesh
	}//smm230624//verticesEdit
}//smm230624//unrealGlobal
}
