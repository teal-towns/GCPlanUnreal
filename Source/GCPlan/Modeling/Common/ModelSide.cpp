...
void ModelSide::Left(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
...
void ModelSide::Right(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
	ModelBase* modelBase = ModelBase::GetInstance();
	scale = FVector(size.X, scale.Y, size.Z);
...
void ModelSide::Back(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
	ModelBase* modelBase = ModelBase::GetInstance();
...
void ModelSide::Front(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
	ModelBase* modelBase = ModelBase::GetInstance();
	scale = FVector(scale.X, size.Y, size.Z);
...
void ModelSide::Bottom(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
	ModelBase* modelBase = ModelBase::GetInstance();
...
void ModelSide::Top(FString name, FVector size, FVector scale, USceneComponent* parent,
	FString mesh, FString material, FVector offset) {
	ModelBase* modelBase = ModelBase::GetInstance();
	scale = FVector(size.X, size.Y, scale.Z);
